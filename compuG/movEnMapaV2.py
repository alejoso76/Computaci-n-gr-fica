        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key==pygame.K_LEFT:
                    ...
                    if posNave[0]<5 and event.type==pygame.KEYDOWN:
                ...
                if event.key==pygame.K_RIGHT:
                    ...
                    pos_x=0
                    reloj.tick(60)
                    if posNave[0]>510 and event.type==pygame.KEYDOWN:
                        pos_x-=8
                        posFondo[0]+=pos_x
                ...
                if event.key==pygame.K_UP:
                    ...
                    pos_y=0
                    reloj.tick(60)
                    if posNave[1]<2 and event.type==pygame.KEYDOWN:
                        pos_y+=8
                        posFondo[1]+=pos_y
                ...
                if event.key==pygame.K_DOWN:
                    ...
                    pos_y=0
                    reloj.tick(60)
                    if posNave[1]>350 and event.type==pygame.KEYDOWN:
                        pos_y-=8
                        posFondo[1]+=pos_y
############################################################################################
                '''
